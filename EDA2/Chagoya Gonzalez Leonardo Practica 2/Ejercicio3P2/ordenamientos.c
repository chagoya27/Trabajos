...
void HeapSort(int *A, int size) {
    BuildHeap(A,size); //construccion de un Max-Heap
    int i;
...
void Heapify(int *A, int i, int size) {//Proceso recursivo para verificar la estructura de un max heap
...
int partition(int arr[], int low, int high) {//acomoda el pivote en su posicion y retorna el valor de dicha posicion
...
void quickSort(int arr[], int low, int high) {//proceso recursivo de quickSort para ordenar una lista partiendola en trozos deacuerdo al pivote
    if(low<high) {
...
void mergeSort(int *array,int low, int high) {//proceso de mergeSort para ir partiendo el arreglo en sub arreglos
...
void merge(int *array, int p, int q, int r) { //realiza la mezcla de los elementos de sub arreglos
